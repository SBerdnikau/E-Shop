    ...
    render(){
        return `<div class="product-in-sc">
                    ...
                    <div class="sh__action" >
                        <a href="#"  class="action" >
                            <i class="far fa-times-circle" data-id="${this.id}" data-name="${this.name}" data-price="${this.price}" data-image="${this.image}" data-quantity="${this.quantity}" ></i>
                        </a>
                    </div>
                </div>`;
    }
        ...
        deleteItemCart(){
            ...
            $container.addEventListener('click', (event) => {
                ...
                if(event.target.classList.contains('fa-times-circle')) {
                    ...
                    .then( () => {
                        $container.removeChild(event.target.classList.contains('product-in-sc'));
                    })
